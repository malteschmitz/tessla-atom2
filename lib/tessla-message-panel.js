...
export default class TeSSLaMessagePanel {
  ...
  constructor(emitter) {
    ...
    $reiter.append( $consoleOutput = $('<div id="console-output"><div class="view-table"></div></div>') )
    $reiter.append( $('<div id="c-error-output"><div class="view-table"></div></div>') )
    $reiter.append( $('<div id="tessla-error-output"><div class="view-table"></div></div>') )
    $reiter.append( $('<div id="warning-output"><div class="view-table"></div></div>') )
    $reiter.append( $('<div id="workflow-output"><div class="view-table"></div></div>') )
  ...
  onAddConsoleText(text) {
    // get element
    var cons = $('#tessla-message-panel-body-wrapper > div#console-output > div.view-table')
    ...
    $line.append( $('<span class="time">' + new Date().toLocaleTimeString('en-US', { hour12: false, hour: "numeric", minute: "numeric"}) + '</span>') )
    $line.append( $('<span class="text">' + text + '</span>') )
    cons.append($line)
  ...
  onAddCErrorText(text) {
    // get element
    var cons = $('#tessla-message-panel-body-wrapper > div#c-error-output > div.view-table')
  ...
  onAddTeSSLaErrorText(text) {
    // get element
    var cons = $('#tessla-message-panel-body-wrapper > div#tessla-error-output > div.view-table')
  ...
  onAddWarningText(text) {
    // get element
    var cons = $('#tessla-message-panel-body-wrapper > div#warning-output > div.view-table')
  ...
  onAddLogText({label, text}) {
    // get element
    var cons = $('#tessla-message-panel-body-wrapper > div#workflow-output > div.view-table')
    ...
    let $line = $('<div class="line">')
    $line.append( $('<span class="time">' + new Date().toLocaleTimeString('en-US', { hour12: false, hour: "numeric", minute: "numeric"}) + '</span>') )
    $line.append( $('<span class="label"><span class="' + label + '">' + label + '</span></span>') )
    $line.append( $('<span class="text">' + text + '</span>') )
    cons.append($line)
  ...
  onClear() {
    $('#tessla-message-panel-body-wrapper > div:visible').text('')
  }
  ...
  onMouseUp(event) {
    ...
    var visiblePre = $('#tessla-message-panel-body-wrapper > div:visible')
    var otherPres  = $('#tessla-message-panel-body-wrapper > div')
  ...
  onMouseMove(event) {
    ...
    // set new height
    $('#tessla-message-panel-body-wrapper > div').height(
  ...
  onSave() {
    ...
    var content = $('#tessla-message-panel-body-wrapper > div:visible').text()
