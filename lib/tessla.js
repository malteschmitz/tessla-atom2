...
export default {
  ...
  activate() {
    ...
    dependencies.install('tessla2').catch(error => {
      console.err(error);
    ...
    this.subscriptions = new CompositeDisposable(
      atom.commands.add('atom-workspace', {
        'tessla2:toggle': () => this.toggle(),
        'tessla2:set-up-split-view': () => this.viewManager.setUpSplitView(),
        'tessla2:build-and-run-c-code': () => this.controller.onCompileAndRunCCode(),
        'tessla2:build-c-code': () => this.controller.onBuildCCode({buildAssembly: false, onSuccess: () => {}, onError: () => {}}),
        'tessla2:run-c-code': () => this.controller.onRunBinary({onSuccess: () => {}, onError: () => {}}),
        'tessla2:stop-current-process': () => this.controller.onStopRunningProcess(),
        'tessla2:build-and-run-project': () => this.controller.onCompileAndRunProject(),
        'tessla2:reset-view': () => this.viewManager.restoreViews()
      }),
