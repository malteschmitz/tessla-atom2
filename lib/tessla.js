...
export const config = {
  useDocker : {
    ...
    default: false,
    order: 4,
    title: "Use TeSSLa docker container",
    description: "Use our TeSSLa docker container instead of native installed tools. If checked the paths entered below are completely ignored"
  },
  clangPath : {
    type: "string",
    default: "/usr/bin/clang",
    order: 5,
    title: "Path to clang compiler",  description: "This should be the path to the clang compiler with LLVM extensions"
  },
